...
该代码由论文的[PyTorch官方实现](https://github.com/yunjey/stargan)通过[X2Paddle](https://github.com/PaddlePaddle/X2Paddle)转换而来，转换过程参考[教程](https://github.com/SunAhong1993/X2Paddle/blob/code_convert_last/docs/pytorch_project_convertor/demo.md#stargan)。  
### 简介
